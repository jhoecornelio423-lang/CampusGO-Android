...
val PureWhite = Color(0xFFFFFFFF)       // Fondo principal limpio (60% UI)
val LightGrayBg = Color(0xFFF4F6F8)     // Tarjetas, contenedores y fondos secundarios (60% UI)
val TextGray = Color(0xFF4B5563)        // Texto normal y descripciones
val SurfaceBorder = Color(0xFFE5E7EB)   // Bordes suaves
